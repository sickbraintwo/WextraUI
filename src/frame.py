...
class Frame:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "image": ("IMAGE", {"tooltip": "The picture to crop, resize and place on the new canvas."}),
                # ---- MASTER ----
                "new_width": ("INT", {"default": 1024, "min": 0, "max": 16384, "tooltip": "The final width. 0 = keep the picture's."}),
                "new_height": ("INT", {"default": 1024, "min": 0, "max": 16384, "tooltip": "The final height. 0 = keep the picture's."}),
                # ---- CROP ----
                ...
                "crop_width": ("INT", {"default": 1024, "min": 1, "max": 16384, "tooltip": "CROP · custom: width after the crop."}),
                "crop_height": ("INT", {"default": 1024, "min": 1, "max": 16384, "tooltip": "CROP · custom: height after the crop."}),
