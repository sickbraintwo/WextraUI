...
class H3HandoffTail:
    ...
    OUTPUT_TOOLTIPS = (
        "The clip's last frame, for the loop's value1.",
        "The hand-off tail cut for the next scene, for the loop's value2.",
        "The hand-off tail's audio, for the loop's value3.",
