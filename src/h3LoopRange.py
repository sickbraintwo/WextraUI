...
class H3LoopRange:
    ...
    OUTPUT_TOOLTIPS = (
        "How many scenes this run renders, for the For Loop's iteration count.",
        "The absolute index of the first scene of the run: add it to the loop index.",
        "The image the first scene of the run starts from, for the loop's initial value1.",
        "The hand-off tail the first scene of the run continues from, for the loop's initial value2.",
        "The hand-off audio the first scene of the run continues from, for the loop's initial value3.",
