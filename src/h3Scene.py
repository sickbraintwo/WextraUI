        ...
        return {
            "required": {
                "prompt": ("STRING", {"forceInput": True,
                                      "tooltip": "The scene's text prompt: the prompt output of WScene Composer H3 "
                                                 "or WSimple Prompt H3."}),
                "duration": ("FLOAT", {"forceInput": True,
                                       "tooltip": "The scene's duration in seconds: the duration output of "
                                                  "WScene Composer H3 or WSimple Prompt H3."}),
                "seed": ("INT", {"default": 0, "min": 0, "max": 0xFFFFFFFFFFFFFFFF,
                                 "tooltip": "Seed for this scene. Set control_after_generate to fixed for a "
                                            "reproducible film."}),
            ...
            "optional": {
                ...
                "ref_image_2": ("IMAGE", {
                    "tooltip": "Reference (character sheet, storyboard, style) — cite as <Picture n>.",
                }),
                "ref_image_3": ("IMAGE", {
                    "tooltip": "Reference (character sheet, storyboard, style) — cite as <Picture n>.",
                }),
