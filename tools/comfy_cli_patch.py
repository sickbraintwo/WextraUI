...
"""WextraUI — local patch for comfy-cli in this venv. Loaded at interpreter start by `wextraui_patch.pth`
...
# ---- patch 2 (2026-09-17, from the agent side of the workbench — see PATCH.md § patch 2): two more gaps of the UI→API translator,
