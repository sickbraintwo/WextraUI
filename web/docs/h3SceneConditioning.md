...
## Sockets
`scenes`, `clip`, `vae`, `audio_vae` (needed for the audio hand-off, guide_audio and ref_audio) · `previous_frame` = loop value1 · `previous_clip` = loop value2 (from *Handoff Tail*) · `previous_audio` = loop value3.
